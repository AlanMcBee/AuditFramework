...
if (schemaDataSet.SchemaTables.TableExists(_params.AuditingSchema, "Catalog"))
{
    priorVersionTrackingTableQuery = from catalog in context.Catalogs
            ...
            this.Write("     [BIGINT]\r\n, @PriorºTrackId    [BIGINT] = NULL OUTPUT\r\nAS\r\n\r\n/*\r\n    READ THI" +
                    ...
                    "since the last recorded values of the fields.\r\n    \r\n    A Baseline record will " +
                    "show all fields as having not changed (all False).\r\n    An Inserted or Deleted r" +
                    "ecord will show all fields as having changed (all True).\r\n    Only the Updated r" +
                    "ecords will show the evaluated changes for each field.\r\n    \r\n    This procedure" +
                    " must compare the current track record, using the current schema \r\n    version, " +
                    "against potentially many earlier schema versions. Where the schema\r\n    has mism" +
                    "atched fields (a field exists in one version of the schema \r\n    but not the oth" +
                    "er), the missing field is treated as a NULL and compared \r\n    against the exist" +
