...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            this.Write("].[BuildDelta]\r\nAS\r\n\r\n/*\r\n    READ THIS BEFORE EDITING THIS CODE\r\n    -----------" +
                    ...
                    "hat have not had a corresponding Delta record built \r\n    to show which fields h" +
                    "ave changed. When it finds a record\r\n    without a Delta record, it calls the De" +
                    "lta* procedure\r\n    to create the Delta record.\r\n    \r\n    The time to call this" +
                    " stored procedure is when you want\r\n    to make sure the AuditMaster, Track, and" +
                    " Delta tables reflect\r\n    all recent changes. It is important to call it just b" +
                    "efore\r\n    attempting to retrieve records, but it is not necessary to \r\n    call" +
                    " this procedure before every single attempt if those attempts\r\n    occur rapidly" +
                    ...
                    "llowed by a new execution of the AuditFramework tool).\r\n    The Delta* procedure" +
                    "s compare prior versions of the tracking tables\r\n    against only the current sc" +
                    "hema version (as of the time the \r\n    AuditFramework tool is run). The results " +
                    "of running BuildDelta on \r\n    records which have not been checked prior to upda" +
